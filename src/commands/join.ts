...
// 			convertPCM(filepath, filename, user, interaction);
// 		});
...
// function convertPCM(filepath, filename, user, interaction) {
...
// 		fs.unlink(filepath, () => {
// 			requestRecognition(newFilename, user, interaction);
// 		});
// 	});
// }

// function requestRecognition(filename, user, interaction) {
...
// 				let channel = interaction.guild.channels.resolve('728239336214102116');
